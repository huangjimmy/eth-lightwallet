...
var signMsgPri = function (keystore, privateKey, rawMsg) {

    var msgHash = util.addHexPrefix(util.sha3(rawMsg).toString('hex'));
    return this.signMsgHashPri(keystore, privateKey, msgHash);
};

module.exports.signMsg = signMsg;
module.exports.signMsgPriv = signMsgPri;

var signMsgHashPri = function (keystore, privateKey, msgHash) {
...
module.exports.signMsgHashPriv = signMsgHashPri;
